...
class TestMCLP:
    ...
    def test_single_supply(self):
        ...
        model = Model.mclp(coverage, max_supply={coverage.supply_name: 5})
    ...
    def test_multiple_supply(self):
        ...
        model = Model.mclp([coverage, coverage2], max_supply={coverage.supply_name: 5, coverage2.supply_name: 10})
        solution = model.solve(pulp.GLPK())
